                      ...
                      <div class="m-demo__preview">
                        <ul class="m-nav">
                          <li class="m-nav__section m-nav__section--first">
                            <span class="m-nav__section-text">Section 1</span>
                          </li>
                          <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                              <i class="m-nav__link-icon flaticon-share"></i>
                          ...
                          <li class="m-nav__section">
                            <span class="m-nav__section-text">Section 2</span>
                          </li>
                          <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                              <i class="m-nav__link-icon flaticon-lifebuoy"></i>
                      ...
                      <div class="m-demo__preview">
                        <ul class="m-nav">
                          <li class="m-nav__item m-nav__item--active">
                            <a href="" class="m-nav__link">
                              <i class="m-nav__link-icon flaticon-share"></i>
                              <span class="m-nav__link-text">Active</span>
                            </a>
                          </li>
                          <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                          ...
                          <li class="m-nav__item m-nav__item--disabled">
                            <a href="" class="m-nav__link">
                              <i class="m-nav__link-icon flaticon-info"></i>
                              <span class="m-nav__link-text">Disabled</span>
                            </a>
                          </li>
                          <li class="m-nav__item">
                            <a href="" class="m-nav__link">
          ...
          <div class="col-lg-6">
            ...
            <div class="m-portlet">
              ...
              <div class="m-portlet__body">
                <!--begin::Section-->
                <div class="m-section m-section--last">
                  <span class="m-section__sub">Nav items can have dot and line style bullets:</span>
                  <div class="m-section__content">
                    <!--begin::Preview-->
                    <div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
                      <div class="m-demo__preview">
                    ...
                    <!--end::Preview-->
                    <!--begin::Dropdown-->
                    <div class="m-dropdown m-dropdown--up m-dropdown--inline  m-dropdown--arrow" m-dropdown-toggle="click">
              ...
              <div class="m-portlet__body">
                ...
                <div class="m-section m-section--last">
                  <div class="m-section__content">
                        ...
                        <div class="m-nav-grid">
                          <div class="m-nav-grid__row">
                            ...
                            <a href="#" class="m-nav-grid__item">
                              ...
                              <span class="m-nav-grid__text">New Event</span>
                            </a>
                            <a href="#" class="m-nav-grid__item">
                              <i class="m-nav-grid__icon flaticon-user"></i>
                              <span class="m-nav-grid__text">Add Member</span>
                            </a>
                          </div>
                          <div class="m-nav-grid__row">
                            <a href="#" class="m-nav-grid__item">
                            ...
                            <a href="#" class="m-nav-grid__item">
                              ...
                              <span class="m-nav-grid__text">Check Logs</span>
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <!--end::Preview-->
                    <!--begin::Dropdown-->
                    <div class="m-dropdown m-dropdown--up m-dropdown--large m-dropdown--inline  m-dropdown--arrow" m-dropdown-toggle="click">
                      <a href="#" class="m-dropdown__toggle btn btn-success dropdown-toggle">
                        Dropdown example
                      </a>
                      <div class="m-dropdown__wrapper">
