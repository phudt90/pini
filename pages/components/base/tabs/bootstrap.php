            ...
            <div class="m-portlet">
              ...
              <div class="m-portlet__body">
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#" data-target="#m_tabs_1_1">Active</a>
                  </li>
            ...
            <div class="m-portlet">
              ...
              <div class="m-portlet__body">
                <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                      <i class="la la-exclamation-circle m--font-success"></i> Dropdown
                    </a>
                    <div class="dropdown-menu">
                      <a class="dropdown-item" data-toggle="tab" href="#m_tabs_1_2">Action</a>
                      <a class="dropdown-item" data-toggle="tab" href="#m_tabs_1_2">Another action</a>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#m_tabs_1_3">
                      <i class="la la-puzzle-piece m--font-danger"></i> Link 2
                    </a>
                  </li>
                  <li class="nav-item">
                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#m_tabs_1_1">
                      <i class="flaticon-interface-5"></i> <span class="m--visible-desktop-inline-block">Active1</span>
                    </a>
                  </li>
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                      <i class="flaticon-time-2 m--font-success"></i> <span class="m--visible-desktop-inline-block">Dropdown</span>
                    </a>
                    <div class="dropdown-menu">
                      <a class="dropdown-item" data-toggle="tab" href="#m_tabs_1_2">Action</a>
                      <a class="dropdown-item" data-toggle="tab" href="#m_tabs_1_2">Another action</a>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#m_tabs_1_3">
                      <i class="flaticon-placeholder-2"></i> <span class="m--visible-desktop-inline-block">Link 1</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#m_tabs_1_3">
                      <i class="flaticon-lock m--font-danger"></i> <span class="m--visible-desktop-inline-block">Link 2</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link disabled" data-toggle="tab" href="#m_tabs_1_4">
                      <i class="flaticon-share"></i> <span class="m--visible-desktop-inline-block">Disabled</span>
                    </a>
                  </li>
                </ul>
                ...
                <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                      <i class="fa fa-file-powerpoint-o m--font-success"></i> Dropdown
                    </a>
                    <div class="dropdown-menu">
                      <a class="dropdown-item" data-toggle="tab" href="#m_tabs_1_2">Action</a>
                      <a class="dropdown-item" data-toggle="tab" href="#m_tabs_1_2">Another action</a>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#m_tabs_1_3">
                      <i class="fa fa-comment m--font-brand"></i> Link 2
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link disabled" data-toggle="tab" href="#m_tabs_1_4">
            ...
            <div class="m-portlet">
              ...
              <div class="m-portlet__body">
                <ul class="nav nav-tabs nav-fill" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#m_tabs_2_1">Active</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#m_tabs_2_2">Link</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#m_tabs_2_3">Link</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link disabled" data-toggle="tab" href="#m_tabs_2_4">Disabled</a>
                  </li>
                </ul>
          ...
          <div class="col-lg-6">
            ...
            <div class="m-portlet">
              ...
              <div class="m-portlet__body">
                <ul class="nav nav-pills" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#m_tabs_3_1">Active</a>
                  </li>
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Dropdown</a>
                    <div class="dropdown-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#m_tabs_3_3">Link</a>
                  </li>
                  <li class="nav-item">
            ...
            <div class="m-portlet">
              ...
              <div class="m-portlet__body">
                <ul class="nav nav-pills" role="tablist">
                  <li class="nav-item ">
                    <a class="nav-link active" data-toggle="tab" href="#m_tabs_3_1"><i class="la la-gear"></i>Active</a>
                  </li>
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#m_tabs_3_3"><i class="la la-map-marker"></i>Link</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link disabled" data-toggle="tab" href="#m_tabs_3_4"><i class="la la-question-circle"></i>Disabled</a>
                  </li>
                </ul>
            ...
            <div class="m-portlet">
              ...
              <div class="m-portlet__body">
                <ul class="nav nav-pills nav-pills--success" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#m_tabs_4_3">Link 1</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#m_tabs_4_3">Link 2</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#m_tabs_4_3">Link 3</a>
                  </li>
                </ul>
                <div class="tab-content">
            ...
            <div class="m-portlet">
              ...
              <div class="m-portlet__body">
                <ul class="nav nav-pills nav-fill" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#m_tabs_5_1">Active</a>
                  </li>
                  <li class="nav-item">
