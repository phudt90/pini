          ...
          <form class="m-form m-form--fit m-form--label-align-right" id="m_form_1" novalidate="novalidate">
            <div class="m-portlet__body">
              ...
              <div class="form-group m-form__group row has-danger">
                ...
                <div class="col-lg-4 col-md-9 col-sm-12">
                  <div class="input-group">
                    <input type="text" class="form-control m-input" name="date" placeholder="Select date" id="m_datepicker" aria-describedby="m_datepicker-error">
                  ...
                  <div id="m_datepicker-error" class="form-control-feedback">This field is required.</div><span class="m-form__help">Select a date</span>
                </div>
              </div>
              <div class="form-group m-form__group row has-danger">
                ...
                <div class="col-lg-4 col-md-9 col-sm-12">
                  <div class="input-group date">
                    <input type="text" class="form-control m-input" name="datetime" placeholder="Select date &amp; time" id="m_datetimepicker" aria-describedby="m_datetimepicker-error">
                    <div class="input-group-append">
                      <span class="input-group-text"><i class="la la-calendar-check-o glyphicon-th"></i></span>
                    </div>
                  </div>
                  <div id="m_datetimepicker-error" class="form-control-feedback">This field is required.</div><span class="m-form__help">Select a date time</span>
                </div>
              </div>
              <div class="form-group m-form__group row">
                ...
                <div class="col-lg-4 col-md-9 col-sm-12">
                  <div class="input-group date">
                    <input type="text" class="form-control m-input" id="m_timepicker" placeholder="Select time" name="time" aria-describedby="m_timepicker-error">
                    <div class="input-group-append">
              ...
              <div class="form-group m-form__group row has-danger">
                ...
                <div class="col-lg-4 col-md-9 col-sm-12">
                  <div class="input-group" id="m_daterangepicker">
                    <input type="text" class="form-control m-input" readonly="" name="daterange" placeholder="Select date range" aria-describedby="daterange-error">
                    <div class="input-group-append">
                      <span class="input-group-text"><i class="la la-calendar-check-o"></i></span>
                    </div>
                  </div>
                  <div id="daterange-error" class="form-control-feedback">This field is required.</div><span class="m-form__help">Select a date range</span>
                </div>
              </div>
              ...
              <div class="form-group m-form__group row">
                ...
                <div class="col-lg-4 col-md-9 col-sm-12">
                  <div class="bootstrap-switch-id-test bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-animate bootstrap-switch-on" style="width: 109px;"><div class="bootstrap-switch-container" style="width: 160px; margin-left: 0px;"><span class="bootstrap-switch-handle-on bootstrap-switch-success" style="width: 53.9px;">ON</span><span class="bootstrap-switch-label" style="width: 54px;">&nbsp;</span><span class="bootstrap-switch-handle-off bootstrap-switch-warning" style="width: 53.9px;">OFF</span><input data-switch="true" type="checkbox" name="switch" id="test" data-on-color="success" data-off-color="warning" aria-describedby="switch-error" aria-invalid="false"></div></div>
              ...
              <div class="form-group m-form__group row has-danger">
                ...
                <div class="col-lg-4 col-md-9 col-sm-12">
                  <div class="dropdown bootstrap-select show-tick form-control m-bootstrap-select"><select class="form-control m-bootstrap-select" id="m_bootstrap_select" multiple="" name="select" tabindex="-98" aria-describedby="m_bootstrap_select-error">
                  ...
                  <div id="m_bootstrap_select-error" class="form-control-feedback">This field is required.</div><span class="m-form__help">Select at least 2 and maximum 4 options</span>
                </div>
              </div>
              ...
              <div class="form-group m-form__group row has-danger">
                ...
                <div class="col-lg-4 col-md-9 col-sm-12">
                  <select class="form-control m-select2 select2-hidden-accessible" id="m_select2" name="select2" data-select2-id="m_select2" tabindex="-1" aria-hidden="true" aria-describedby="m_select2-error">
                  ...
                  </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="1" style="width: 382.656px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-m_select2-container"><span class="select2-selection__rendered" id="select2-m_select2-container" role="textbox" aria-readonly="true"><span class="select2-selection__placeholder">Select a state</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                  <div id="m_select2-error" class="form-control-feedback">This field is required.</div><span class="m-form__help">Select an option</span>
                </div>
              </div>
