                      ...
                      <div class="m-demo__preview">
                        ...
                        <form class="m-form">
                          ...
                          <div class="m-form__group form-group row">
                            ...
                            <label class="col-3 col-form-label">Accent</label>
                            <div class="col-3">
											<span class="m-switch m-switch--accent">
												<label>
						                        <input type="checkbox" checked="checked" name="">
						                        <span></span>
						                        </label>
                          ...
                          <div class="m-form__group form-group row">
                            ...
                            <div class="col-3">
											<span class="m-switch m-switch--brand">
												<label>
						                        <input type="checkbox" checked="checked" name="">
						                        <span></span>
						                        </label>
                            ...
                            <label class="col-3 col-form-label">Metal</label>
                            <div class="col-3">
											<span class="m-switch m-switch--metal">
												<label>
						                        <input type="checkbox" checked="checked" name="">
						                        <span></span>
						                        </label>
                      ...
                      <div class="m-demo__preview">
                        ...
                        <form class="m-form">
                          <div class="m-form__group form-group row">
                            ...
                            <label class="col-3 col-form-label">Warning</label>
                            <div class="col-3">
											<span class="m-switch m-switch--outline m-switch--warning">
												<label>
						                        <input type="checkbox" checked="checked" name="">
						                        <span></span>
						                        </label>
                          ...
                          <div class="m-form__group form-group row">
                            ...
                            <label class="col-3 col-form-label">Accent</label>
                            <div class="col-3">
											<span class="m-switch m-switch--outline m-switch--accent">
												<label>
						                        <input type="checkbox" checked="checked" name="">
						                        <span></span>
						                        </label>
                          ...
                          <div class="m-form__group form-group row">
                            ...
                            <label class="col-3 col-form-label">Metal</label>
                            <div class="col-3">
											<span class="m-switch m-switch--outline m-switch--metal">
												<label>
						                        <input type="checkbox" checked="checked" name="">
						                        <span></span>
						                        </label>
                      ...
                      <div class="m-demo__preview">
                        ...
                        <form class="m-form">
                          ...
                          <div class="m-form__group form-group row">
                            ...
                            <label class="col-3 col-form-label">Metal</label>
                            <div class="col-3">
											<span class="m-switch m-switch--outline m-switch--icon m-switch--metal">
												<label>
						                        <input type="checkbox" checked="checked" name="">
						                        <span></span>
						                        </label>
